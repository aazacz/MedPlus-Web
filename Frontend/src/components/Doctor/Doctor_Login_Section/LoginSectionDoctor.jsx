...
function LoginSectionDoctor() {
    ...
    const HandleSubmit = (event) => {
        ...
        axios.post("http://localhost:6002/doctor/login", LoginDetail).then((res) => {
            console.log(res);
    ...
    return (
        <section className="h-auto md:py-[60px] mx-5  flex items-center justify-center 
            ...
            <div className=' h-[445px] bg-blue rounded-md  shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]
                            md:flex md:w-[800px] 
                            lg:flex'>
                    ...
                    <div className='mx-3 w-full h-full  flex items-center
                        ...
                        <form className=' md:w-full h-3/4   md:border-l-[1px] flex flex-col  items-center 
                            ...
                            <div className='flex h-[50px] w-full mt-6 items-center justify-center '>
                                ...
                                <button className='rounded-[4px] ml-4 text-lightgreen w-[120px] border-2 border-lightgreen h-8' onClick={()=>navigate("/doctor/signup")} > SIGNUP</button>
