    ...
    return (
        <>
            ...
            <div className='md:h-[145px] md:mx-12 '>
                <nav className='p-5 w-full bg-blue md:bg-transparent flex justify-between  px-10 overflow-x-hidden 
                    ...
                    <ul className='md:h-12 flex  flex-col text-white  bg-blue  z-[99]  absolute  left-0  w-full  opacity-0   top-[-400px]   transition md:transition-non ease-in  duration-500 
                      md:flex   md:flex-row   
                    md:align-middle  md:z-auto md:top-[100px] md:opacity-100  md:justify-end
                        ...
                        <li onClick={()=>navigate('/login')} className='mx-4 cursor-pointer text-left my-2 md:my-auto '> <a href="" className="text-lg hover:text-red duration-300" >USER</a></li>
                        ...
                        <li className='mx-4 cursor-pointer text-left my-2 md:my-auto '> <button onClick={()=>navigate("/doctor")} className='hidden md:block bg-cyan text-white font-[Arial] px-6 py-2 mx-4 hover:bg-red rounded duration-200'> Login </button></li>
