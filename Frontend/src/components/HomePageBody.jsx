...
import doctorGroupPhoto from '../assets/doctorGroupPhoto.jpg'
function HomePageBody() {


    return (
        <>
            <section className=" h-auto mt-8   xl:mx-[150px] ">
                ...
                <div className=" mt-4    md:w-full  md:flex md:mt-[20px] md:justify-between md:flex-row center  
                ...
                <div className=" w-full  mt-5 rounded-md  flex">
                    ...
                    <div className="flex w-1/2 ml-[30px] h-full gap-3 flex-wrap">

                        {Homepageitems.map((values, index) => {
                            return (
                                <div key={index} className="w-[100px] hover:border-[2px] flex flex-col  align-middle justify-center rounded-lg hover:border-orange-600  border-2 h-[100px] bg-white text-black text-xs shrink-0 shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] ">{values.name}
