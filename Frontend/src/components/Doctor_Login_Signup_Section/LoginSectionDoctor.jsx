                    ...
                    <div className='mx-3 w-full h-full  flex items-center
                        ...
                        <form action="" onSubmit={HandleSubmit}>
                            <div className=' md:w-full h-3/4   md:border-l-[1px] flex flex-col  items-center 
                                ...
                                <input className=' my-6 md:mt-5 w-[330px] h-[50px] border-b-[1px] focus:outline-none' placeholder='Password' type="text"  onChange={(e) => { SetLoginDetail({...LoginDetail, password: e.target.value }); }} />
