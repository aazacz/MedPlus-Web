...
import axiosInstanceUser from './AxiosInstance/User/AxiosinstanceUser';
import axiosInstanceDoctor from './AxiosInstance/Doctor/axiosInstanceDoctor';
    ...
    return new Promise((resolve,reject)=>{
        if (Cookies.get('DoctorjwtCookie')) {
          ...
          .then((res) => {
            ...
            if (res.data.message === "Authorised") {
           console.log("authorised and resolving true");
